...
public class ListViewListMenuAdapter extends ArrayAdapter<Menu> {
	private Context context;
	private List<Menu> list;
	private int layout;
    public ImageLoader imageLoader; 

	public ListViewListMenuAdapter(Context context, int layout, List<Menu> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			viewHolder.tvNameMenu = (TextView) view.findViewById(R.id.tv_name_menu_by_category);
			viewHolder.tvFlagMenu = (TextView) view.findViewById(R.id.tv_flag_menu_by_category);
			viewHolder.ivPictureMenu = (SquareImageView) view.findViewById(R.id.iv_picture_menu_by_category);
			viewHolder.llFlagMenu = (LinearLayout) view.findViewById(R.id.ll_flag_menu_by_category);
			viewHolder.flMenu = (FrameLayout) view.findViewById(R.id.fl_menu_by_category);
